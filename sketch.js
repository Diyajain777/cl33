...
function setup() 
{
  ...
  if(isMobile){
    rope = new Rope(4,{x:40,y:30});
  rope2 = new Rope(3,{x:width/2+20,y:40});
  rope3 = new Rope(6,{x:width-30,y:225});

  }
  else{
    rope = new Rope(20,{x:40,y:30});
  rope2 = new Rope(7,{x:width/2+20,y:40});
  rope3 = new Rope(22,{x:width-30,y:225});
